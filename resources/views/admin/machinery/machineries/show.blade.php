...
<script>
    ...
    function openModal(){ if(modal) { modal.classList.remove('hidden'); document.body.classList.add('overflow-hidden'); } }
    ...
    var editSerial = document.getElementById('edit_serial');
