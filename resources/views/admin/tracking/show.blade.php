    ...
    <div class="waste-header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('admin.tracking.download.pdf', $tracking) }}" class="bg-red-500 hover:bg-red-600 text-white p-2 rounded-lg transition-colors duration-200" title="Descargar PDF">
                    <i class="fas fa-file-pdf"></i>
                </a>
                <a href="{{ route('admin.tracking.edit', $tracking) }}" class="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-lg transition-colors duration-200" title="Editar">
                    <i class="fas fa-edit"></i>
                </a>
                <a href="{{ route('admin.tracking.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white p-2 rounded-lg transition-colors duration-200" title="Volver">
