    ...
    <div class="waste-header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.tracking.edit', $tracking) }}" class="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-lg transition-colors duration-200" title="Editar">
                    <i class="fas fa-edit"></i>
                </a>
                <a href="{{ route('admin.tracking.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white p-3 rounded-lg transition-colors duration-200" title="Volver">
