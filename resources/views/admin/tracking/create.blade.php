...
<div class="waste-container">
    ...
    <div class="waste-header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Registra el progreso de la pila de compostaje</p>
            </div>
            <a href="{{ route('admin.tracking.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200 flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.tracking.store') }}" method="POST" class="p-8">
            @csrf
