                    ...
                    <div class="bg-green-50 rounded-lg p-4 border border-green-200">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="/admin/tracking/composting/${data.composting.id}/download/pdf" class="bg-red-500 hover:bg-red-600 text-white p-2 rounded-lg transition-colors duration-200" title="Descargar PDF de esta Pila">
