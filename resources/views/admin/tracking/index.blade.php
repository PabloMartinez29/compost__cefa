    ...
    <div class="waste-header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Registra y monitorea el progreso de las pilas de compostaje</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        @else
            <div class="p-12 text-center">
                ...
                <a href="{{ route('admin.composting.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200 inline-flex items-center">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-green-100 text-sm">Monitorea el progreso de la pila de compostaje</p>
                        </div>
                    </div>
            ...
            if (data.trackings && data.trackings.length > 0) {
                                            ...
                                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                                ...
                                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-2">
                                                        <a href="/admin/tracking/${tracking.id}" 
                ...
                modalContent.innerHTML = `
                    <div class="text-center py-8">
                        ...
                        <a href="/admin/tracking/create?composting_id=${compostingId}" class="mt-4 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
                            <i class="fas fa-plus mr-2"></i>
