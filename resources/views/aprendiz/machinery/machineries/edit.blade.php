...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="waste-card animate-fade-in-up animate-delay-1">
        ...
        <div class="p-8">
            <form action="{{ route('aprendiz.machinery.update', $machinery) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                @method('PUT')
                <!-- Primera fila -->
                        ...
                        <div class="relative">
                            ...
                            <div id="imagePreview" class="mt-4 hidden">
                                <div class="relative inline-block">
                                    ...
                                    <img id="previewImg" class="w-full h-48 object-cover rounded-xl border-2 border-gray-300 shadow-lg" alt="Preview">
