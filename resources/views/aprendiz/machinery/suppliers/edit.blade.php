...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="waste-card animate-fade-in-up animate-delay-1">
        ...
        <div class="p-8">
            <form action="{{ route('aprendiz.machinery.supplier.update', $supplier) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="relative">
                            <select name="machinery_id" required
                                ...
                                @foreach($machineries as $machinery)
                                    <option value="{{ $machinery->id }}" {{ old('machinery_id', $supplier->machinery_id) == $machinery->id ? 'selected' : '' }}>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="maker" maxlength="150" required
                               value="{{ old('maker', $supplier->maker) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="origin" maxlength="150" required
                               value="{{ old('origin', $supplier->origin) }}"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="purchase_date" required
                               value="{{ old('purchase_date', $supplier->purchase_date->format('Y-m-d')) }}"
                               max="{{ date('Y-m-d') }}"
