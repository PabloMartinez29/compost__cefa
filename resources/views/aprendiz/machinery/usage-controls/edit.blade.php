...
<div class="container mx-auto px-3 sm:px-6 py-4 sm:py-8">
    ...
    <div class="waste-header animate-fade-in-up">
        <div>
            <h1 class="text-xl sm:text-3xl font-bold text-gray-800">
                <i class="fas fa-edit text-green-500 mr-2 sm:mr-3"></i>
    ...
    <div class="waste-card animate-fade-in-up animate-delay-1">
        ...
        <div class="p-4 sm:p-6 md:p-8">
            <form action="{{ route('aprendiz.machinery.usage-control.update', $usageControl) }}" method="POST" class="space-y-6 sm:space-y-8" id="usageControlForm">
                @csrf
                @method('PUT')
