...
<div class="container mx-auto px-3 sm:px-6 py-4 sm:py-8">
    ...
    <div class="waste-card animate-fade-in-up animate-delay-1">
        ...
        <div class="p-4 sm:p-6 md:p-8">
            <form action="{{ route('aprendiz.machinery.usage-control.store') }}" method="POST" class="space-y-6 sm:space-y-8" id="usageControlForm">
                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateHours() {
        if (startDateInput.value && endDateInput.value) {
            ...
            // Si no hay fecha de fin, dejar horas en 0
            hoursInput.value = 0;
        }
    }
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: `¿Estás seguro de que deseas registrar el uso del equipo: ${machineryName}?`,
                icon: 'question',
