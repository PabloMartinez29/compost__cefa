        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="waste-container animate-fade-in-up animate-delay-2">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('aprendiz.fertilizer.edit', $fertilizer) }}" class="waste-btn-secondary">
                            <i class="fas fa-edit mr-2"></i>
                            Editar Registro
                        </a>
                        <a href="{{ route('aprendiz.fertilizer.index') }}" class="waste-btn">
                            <i class="fas fa-list mr-2"></i>
                            Volver a la Lista
                        </a>
                        <form action="{{ route('aprendiz.fertilizer.destroy', $fertilizer) }}" method="POST" 
